...
use yii\helpers\Url;
/** @var \app\web\theme\extensions\DefaultTheme\models\ThemeWidgets $model */
            ...
            <article class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                ...
                Html::dropDownList(
                    ...
                    [ 0 => Yii::t('app', 'Select theme part to add') ]
                        + \yii\helpers\ArrayHelper::map(\app\web\theme\extensions\DefaultTheme\models\ThemeParts::getAllParts(), 'id', 'name'),
                    [
