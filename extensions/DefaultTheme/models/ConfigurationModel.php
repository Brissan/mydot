...
namespace app\web\theme\extensions\DefaultTheme\models;

use app;
use app\web\theme\extensions\DefaultTheme\components\StylesCompiler;
use Yii;
...
class ConfigurationModel extends app\models\BaseThemeConfigurationModel
{
    ...
    {
        /** @var app\web\theme\extensions\DefaultTheme\Module $module */
