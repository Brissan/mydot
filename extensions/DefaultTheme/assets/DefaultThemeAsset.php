...
namespace app\web\theme\extensions\DefaultTheme\assets;
 ...
 *
 * @package app\web\theme\extensions\DefaultTheme\assets
 */
class DefaultThemeAsset extends AssetBundle
{
    ...
    public $depends = [
        'app\assets\AppAsset',
        'app\web\theme\extensions\DefaultTheme\assets\BootstrapHoverDropdown',
    ];
}
